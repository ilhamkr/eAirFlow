...
{
    public class PaidReservationState : BaseReservationState
    {
        public PaidReservationState(_210019Context context, IMapper mapper, IServiceProvider serviceProvider) : base(context, mapper, serviceProvider)
        {
        }
