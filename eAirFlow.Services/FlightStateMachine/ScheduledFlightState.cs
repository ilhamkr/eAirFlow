...
{
    public class ScheduledFlightState : BaseFlightState
    {
        public ScheduledFlightState(_210019Context context, IMapper mapper, IServiceProvider serviceProvider) : base(context, mapper, serviceProvider)
        {
        }
