...
{
    public class CompletedFlightState : BaseFlightState
    {
        public CompletedFlightState(_210019Context context, IMapper mapper, IServiceProvider serviceProvider) : base(context, mapper, serviceProvider)
        {
        }
        ...
        {
            throw new InvalidOperationException("Completed flight cannot be cancelled.");
        }

        public override Model.Models.Flight Delay(int id)
        {
            throw new InvalidOperationException("Completed flight cannot be delayed.");
        }

        public override Model.Models.Flight Complete(int id)
        {
            throw new InvalidOperationException("Flight is already completed.");
        }
