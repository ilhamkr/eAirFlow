...
namespace eAirFlow.Services.Migrations
{
    ...
    [Migration("20251208192824_FlightsAirportsFix")]
    partial class FlightsAirportsFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eAirFlow.Services.Database.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HireDate = new DateTime(2025, 12, 8, 19, 28, 23, 872, DateTimeKind.Utc).AddTicks(8936),
                            Name = "employee",
                            PhoneNumber = "555-555",
                            PositionId = 1,
                            Surname = "employee",
            ...
            modelBuilder.Entity("eAirFlow.Services.Database.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2025, 12, 8, 19, 28, 23, 872, DateTimeKind.Utc).AddTicks(8841),
                            Email = "user@example.com",
                            Name = "User",
                            PasswordHash = "jZrOC6CYFypqOeB8enFGThCovTPl4KdHS5C0K6JIhOM=",
                            PasswordSalt = "BDvRAIAwklz5V63ZSgrzBQ==",
                            PhoneNumber = "555-555",
                            Surname = "User"
                        },
                        new
                        {
                            UserId = 2,
                            CreatedAt = new DateTime(2025, 12, 8, 19, 28, 23, 872, DateTimeKind.Utc).AddTicks(8862),
                            Email = "employee@example.com",
                            Name = "Employee",
                            PasswordHash = "jZrOC6CYFypqOeB8enFGThCovTPl4KdHS5C0K6JIhOM=",
                            PasswordSalt = "BDvRAIAwklz5V63ZSgrzBQ==",
                        ...
                        {
                            UserId = 3,
                            CreatedAt = new DateTime(2025, 12, 8, 19, 28, 23, 872, DateTimeKind.Utc).AddTicks(8876),
